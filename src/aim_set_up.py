import os
import sys
sys.path.insert(1, '/net/scratch2/w06498gk/REG/src/')
...
def Interactions(atom_list, existing_int_atoms, wfn_root, root_dirs):
    ...
    intra_files = []
    inter_files = []
    atoms = aim_u.get_atom_list(wfn_root)
...
if __name__=="__main__":
    ...
    Variables.
    '''
    atom_selection = [172,173,174,175,170,169,197,198,199,200,201,202,196,195,184,236,238,237,95,87,171,168,176,179,182,166,167,189,186,185,177,178,187,188,180,181,183,162,161,160,129,127,125,128,93,193,227,163,165,164,31,42,203,204,70,61,69,59,94,92,23,32,231,233,234,235,230,88,73,2,21,183,211,212,190,22,35,33,77,52,40,78,128,124,218,217,219,220,221,209,208,210,207,205,206]
